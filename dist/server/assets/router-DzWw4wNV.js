import { f as functionalUpdate$1, a as arraysEqual, c as createLRUCache, i as isPromise, b as isRedirect, d as isNotFound, e as invariant, g as createControlledPromise, r as rootRouteId, h as isServer$1, j as compileDecodeCharMap, t as trimPath, k as rewriteBasepath, l as composeRewrites, p as processRouteTree, m as processRouteMasks, n as resolvePath, o as cleanPath, q as trimPathRight, s as parseHref, u as executeRewriteInput, v as isDangerousProtocol, w as redirect, x as findSingleMatch, y as deepEqual, D as DEFAULT_PROTOCOL_ALLOWLIST, z as buildRouteBranch, A as interpolatePath, B as nullReplaceEqualDeep, C as replaceEqualDeep$1, E as last, F as decodePath, G as findFlatMatch, H as findRouteMatch, I as hasKeys, J as executeRewriteOutput, K as encodePathLikeUrl, L as trimPathLeft, M as joinPaths, N as useRouter, O as dummyMatchContext, P as matchContext, Q as exactPathTest, R as removeTrailingSlash, S as useHydrated, T as escapeHtml, U as isInlinableStylesheet, V as getAssetCrossOrigin, W as resolveManifestAssetLink, X as Outlet } from "./server-BJF9T5_C.js";
import { r as reactExports, R as React, j as jsxRuntimeExports, u as useScroll, b as useTransform, m as motion } from "./motion-CItmpJlh.js";
import { r as requireReactDom } from "./three-BtqM4Udt.js";
import { S as Sun, M as Moon } from "./icons-BaiXR8I7.js";
...
const appCss = "/assets/styles-6SD1GO58.css";
...
function AppleNav() {
  ...
  const bg = useTransform(scrollY, [0, 80], ["rgba(0,0,0,0)", "var(--nav-bg-scrolled)"]);
  const border = useTransform(scrollY, [0, 80], ["rgba(0,0,0,0)", "var(--nav-border-scrolled)"]);
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    motion.nav,
    {
      style: { backgroundColor: bg, borderBottomColor: border },
      className: "fixed top-0 inset-x-0 z-50 backdrop-blur-xl border-b",
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-6 h-12 flex items-center justify-between text-[13px] font-medium", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#", className: "text-foreground/90", children: "◆ Ali" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden md:flex items-center gap-8 text-foreground/70", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#experience", className: "hover:text-foreground transition-colors", children: "Experience" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#contact", className: "text-[#3B82F6] hover:text-foreground transition-colors", children: "Hire →" })
        ] })
      ] })
    }
  );
...
const Scene3D = reactExports.lazy(
  () => import("./Scene3D-Kryjwl0X.js").then((module) => ({ default: module.Scene3D }))
);
function AppleHero() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { ref: containerRef, className: "relative min-h-[110vh] flex items-center justify-center px-6 overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { style: { opacity, scale }, className: "absolute inset-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: null, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Scene3D, { mouse }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-vignette pointer-events-none" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 size-[40rem] rounded-full bg-[#3B82F6]/15 blur-[120px] apple-glow pointer-events-none" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { style: { y, opacity }, className: "relative z-10 text-center max-w-5xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.p,
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.p,
        {
          ...
          children: "Building high-performance decentralized systems."
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#projects", className: "px-7 py-3 rounded-full bg-[#3B82F6] text-white font-medium text-base hover:bg-[#3B82F6]/90 transition-colors", children: "Explore Work" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#contact", className: "px-7 py-3 rounded-full glass font-medium text-base hover:bg-white/10 transition-colors", children: "Get in Touch" })
          ]
        }
      )
    ] }),
...
const AppleSections = reactExports.lazy(
  () => import("./AppleSections-BMGi5b4j.js").then((module) => ({
...
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Rust Blockchain Developer building high-performance decentralized systems across EVM, Solana and ICP."
      },
...
function Index() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "min-h-screen relative bg-background text-foreground", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(AppleNav, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(AppleHero, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: null, children: /* @__PURE__ */ jsxRuntimeExports.jsx(AppleSections, {}) })
  ] });
}
